<template>
  <li
    ...
    @pointerdown.stop.prevent="onClickResult"
...
<style lang="scss">
$mt-select-result-active-color-background: lighten($color-contena-brand-500, 40%);
$mt-select-result-active-color-text: $color-contena-brand-500;
