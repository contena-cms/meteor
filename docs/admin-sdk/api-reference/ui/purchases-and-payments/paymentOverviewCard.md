...
A payment overview card allows extensions to customize how a payment method appears in the payment methods overview in the Contena Administration.

Starting with Contena **6.4.14.0**, extensions can replace the default payment method card with a custom component. This makes it possible to add additional logic before a payment method can be activated.
