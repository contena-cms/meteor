This repository contains the Design Tokens for the Meteor Design System at contena.

## Installation

```sh
npm install @contena/meteor-tokens
```
...
- Primitive tokens
- Tokens for the Contena 6 Administration (light & dark)

As an example we'll show you how to make use of the tokens
for the Contena 6 Administration.

Import the CSS files that contain the corresponding tokens.

```js
import '@contena/meteor-tokens/administration/light.css';

// If you want to support dark mode
import '@contena/meteor-tokens/administration/dark.css';
```
...
Contena 6 is completely free and released under the [MIT License](./LICENSE.md).
