# @contena/meteor-tokens

## 1.4.1

### Patch Changes

- 6b3238d: - Changed `color/text/primary/default` to map to `color/zinc/100` instead of `color/zinc/50` in dark mode
...
- [#1049](https://github.com/contena/meteor/pull/1049) [`01879a1`](https://github.com/contena/meteor/commit/01879a18a412afbaf96c070f7b5fa459a8a56b39) Thanks [@alastair-simon](https://github.com/alastair-simon)! - - Upgraded typescript-eslint from 8.24.1 to 8.35.0
