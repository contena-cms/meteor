...
Extensions can localize text displayed in the Contena Administration using snippet files and a frontend translation library.
...
For text rendered [inside](../concepts/locations.md) native Administration UI components (such as titles inside [component sections](../concepts/component-sections.md)), Contena supports snippet files inside the app.
...
Snippet files follow the same structure used by the Contena Administration. Overriding existing Administration snippets is possible, if needed.
...
ui.componentSection.add({
    component: 'card', 
    positionId: 'ct-manufacturer-card-custom-fields__before',
    props: {
