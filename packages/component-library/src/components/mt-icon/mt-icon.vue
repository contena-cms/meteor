...
const icons = import.meta.glob("/node_modules/@contena/meteor-icon-kit/icons/**/*.svg", {
  import: "default",
  eager: false,
});
...
watch(
  iconInformation,
  () => {
    const iconPath = `/node_modules/@contena/meteor-icon-kit/icons/${iconInformation.value.mode}/${iconInformation.value.name}.svg`;
