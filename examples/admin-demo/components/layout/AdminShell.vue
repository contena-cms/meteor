<template>
  <div class="admin-shell" :class="{ 'admin-shell--collapsed': collapsed }">
    <AdminSidebar :groups="groups" :collapsed="mobileOpen ? false : collapsed" :mobile-open="mobileOpen" @toggle="handleSidebarToggle" @mobile-close="mobileOpen = false" />
...
.admin-breadcrumb { position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(0 0 0 0); white-space: nowrap; }
