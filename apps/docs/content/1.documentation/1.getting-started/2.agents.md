...
```bash [Claude Code]
claude mcp add --transport http meteor https://meteor.contena.cn/mcp
```
...
```json [Cursor]
{
  "mcpServers": {
    "meteor": {
      "type": "http",
      "url": "https://meteor.contena.cn/mcp"
    }
  }
}
```
...
```json [Claude Desktop]
{
  "mcpServers": {
    "meteor": {
      "command": "npx",
      "args": ["mcp-remote", "https://meteor.contena.cn/mcp"]
    }
  }
}
```
...
- "What does the Meteor migration guide say about replacing ct- components?"
...
| File | Description |
| --------------------------------------------- | ------------------------------------------------------------------ |
| [`/llms.txt`](https://meteor.contena.cn/llms.txt) | A concise index of the documentation with links to each page. |
| [`/llms-full.txt`](https://meteor.contena.cn/llms-full.txt) | The complete documentation inlined into a single file. |
...
```text
https://meteor.contena.cn/raw/documentation/getting-started/migration.md
```
...
- "Using https://meteor.contena.cn/llms.txt, which component should I use for a confirmation dialog?"
- "Summarize https://meteor.contena.cn/raw/components/button.md"
