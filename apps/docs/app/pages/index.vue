...
import MtThemeProvider from "@contena/meteor-component-library/MtThemeProvider";
...
const githubUrl = appConfig.github?.url ?? "https://github.com/contena/meteor";
const npmUrl =
  "https://www.npmjs.com/package/@contena/meteor-component-library";
...
// "%s - Contena Meteor" title suffix to avoid doubled branding.
...
const npmBase = "https://www.npmjs.com/package/@contena/";

// `icon` is a Meteor icon-kit name, rendered via <mt-icon name="regular-…">.
const benefits = [
  {
    icon: "contena",
    title: "Built for Contena",
  ...
  <div class="landing">
    ...
    <section class="hero relative isolate overflow-clip">
      ...
      >
        ...
        >
          Build outstanding Contena experiences with
        ...
        <div class="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <header v-reveal class="lg:col-span-5">
            ...
            >
              ...
              that Contena and its community design and build on together.
            </p>
          </header>
              ...
              >
                ...
                <p class="leading-relaxed text-muted">
                  ...
                  <span class="text-highlighted break-all"
                    >@contena/meteor-component-library</span
                  >
                </p>
              </div>
            </div>
      ...
      <UContainer>
        ...
        <div class="mt-12">
          ...
          >
            ...
            <LandingCopyCommand :command="`npm i @contena/${pkg.name}`" />
          </div>
        </div>
      </UContainer>
    </section>
