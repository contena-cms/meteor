...
The Meteor Admin SDK provides tools for accessing and manipulating Contena data from within the Administration. These APIs allow extensions to interact with Contena entities, react to changes in data, and update records using the same repository-based data layer used by the Administration itself.
...
- [Repository](./repository.md): Access Contena entity repositories.
