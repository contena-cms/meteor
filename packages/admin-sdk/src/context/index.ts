...
export const getContenaVersion = createSender('contextContenaVersion', {});
export const compareIsContenaVersion = getCompareIsContenaVersion(getContenaVersion);
...
/**
 * Get the current Contena version
 */
export type contextContenaVersion = {
  responseType: string,
}
