---
title: Promo Badge
description: A specialized Badge for predefined promotional labels such as New, Beta, or Contena AI.
---
...
**Promo Badge** highlights promotional elements across our products with predefined feature labels such as `New`, `Beta`, or `Contena AI`. Use it when a promotional label should stand out consistently without inventing a new visual treatment.

```ts
import { MtPromoBadge } from "@contena/meteor-component-library";
```
...
- Keep the meaning consistent with the defined variants such as `New`, `Beta`, and `Contena AI`.
