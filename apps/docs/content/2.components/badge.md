...
```ts
import { MtBadge } from "@contena/meteor-component-library";
```
...
- [**Promo Badge**](/components/promo-badge): when the label is a predefined promotional label such as `New`, `Beta`, or `Contena AI`.
