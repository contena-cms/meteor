...
Menu items allow extensions to add navigation entries to existing areas of the Contena Administration menu.
...
Add a new menu item to the Contena admin menu. The content of the menu item module is determined by your `locationId`.
...
| `parent`           | false    | 'ct-extension' | Determines under which main menu entry your item is displayed |
