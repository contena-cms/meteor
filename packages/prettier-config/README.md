# @contena/meteor-prettier-config

A shared prettier config for contena projects.
...
```bash
npm i -D @contena/meteor-prettier-config
```

With pnpm:

```bash
pnpm i -D @contena/meteor-prettier-config
```
...
```jsonc
{
  ...
  "prettier": "@contena/meteor-prettier-config",
}
```
...
```js
import meteorPrettierConfig from "@contena/meteor-prettier-config";
