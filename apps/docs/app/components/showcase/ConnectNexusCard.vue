...
import MtPasswordField from "@contena/meteor-component-library/MtPasswordField";
import MtButton from "@contena/meteor-component-library/MtButton";
import MtLink from "@contena/meteor-component-library/MtLink";
          ...
          <div ref="formRef" class="connect__body">
            <div class="connect__head">
              ...
              <mt-text size="xs" :color="muted">
                Sign in with your Contena Account to connect Nexus and turn
