[![npm version](https://badge.fury.io/js/@contena-ag%2Fmeteor-icon-kit.svg)](https://badge.fury.io/js/@contena-ag%2Fmeteor-icon-kit)
...
```sh
$ npm install @contena/meteor-icon-kit
```

Or if you prefer using Yarn:

```sh
$ yarn add @contena/meteor-icon-kit
```
...
```js
import wallet from "@contena/meteor-icon-kit/icons/regular/wallet.svg";
```
...
<script setup>
import ActivityIcon from "@contena/meteor-icon-kit/icons/regular/activity.svg";
</script>
```
