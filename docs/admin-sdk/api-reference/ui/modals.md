...
Modals display dialog windows in front of the Contena Administration interface.
...
```ts
import { notification, ui } from "@contena/meteor-admin-sdk";
```
...
| Name          | Required | Default   | Description                                                                                    | Available at Contena |
| :------------ | :------- | :-------- | :--------------------------------------------------------------------------------------------- | :-------------------- |
...
> Available since Contena 6.7.1.0
