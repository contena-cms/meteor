...
export type cmsRegisterElement = {
     ...
     * @url https://developer.contena.cn/docs/guides/plugins/plugins/content/cms/add-cms-element
     */
    defaultConfig: {
        [key: string]: unknown,
    },
...
export type cmsRegisterBlock = {
    ...
    /**
     * A unique technical name for your block. We recommend to use a shorthand prefix for your company, e.g. "Ct" for contena AG.
     */
    name: string,
     ...
     * 
     * New custom categories will get the following snippet key: "apps.ct-cms.detail.label.blockCategory.{categoryName}"
     */
