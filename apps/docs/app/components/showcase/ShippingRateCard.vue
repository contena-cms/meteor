...
import MtSelect from "@contena/meteor-component-library/MtSelect";
import MtInset from "@contena/meteor-component-library/MtInset";
import MtUnitFieldComponent from "@contena/meteor-component-library/MtUnitField";
    ...
    <div class="stack">
      ...
      <div class="ship-summary">
        <div class="ship-line">
          ...
          <mt-text size="2xs" :color="muted">北京市朝阳区建国路 88 号</mt-text>
        </div>
        <div class="ship-line">
          <mt-icon
