...
2. Once the component and its stories are in place, document it on this docs site: add a page with live examples, an API reference, and usage guidance. Follow the [content standard](https://github.com/contena/meteor/blob/main/apps/docs/DOCS_STANDARD.md) for the page structure and conventions.
