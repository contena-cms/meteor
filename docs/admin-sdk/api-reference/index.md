...
The Meteor Admin SDK provides APIs for extending the Contena Administration UI and interacting with Administration data.
...
These components allow extensions to add UI elements to the Contena Administration. They can be used to register modules, add navigation entries, extend existing pages, and display dialogs or side panels.
...
These tools allow extensions to access and manipulate Contena entity data from within the Administration.
...
- [Repository](./data/repository.md): Access Contena entity repositories
- [Get](./data/get.md)
...
These APIs allow extensions to add new CMS blocks and elements to the Contena Shopping Experiences editor.
