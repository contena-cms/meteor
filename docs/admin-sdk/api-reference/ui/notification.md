...
Notifications display messages in the Contena Administration to inform users about events, errors, or completed actions. They remain visible in the notification center (bell icon) until dismissed by the user.
