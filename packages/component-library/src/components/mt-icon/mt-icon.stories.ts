...
import iconMeta from "@contena/meteor-icon-kit/icons/meta.json";
...
const allIcons = Object.keys(
  import.meta.glob("/node_modules/@contena/meteor-icon-kit/icons/**/*.svg"),
)
  .map((path) => {
    const relativePath = path
      .replace("/node_modules/@contena/meteor-icon-kit/icons/", "")
      .replace(".svg", "");
    ...
    setup() {
      return {
        commonUsages: [
          ...
          { icon: "plans", label: "Contena Plans" },
          { icon: "contena-nexus", label: "Contena Nexus" },
          { icon: "contena-payments", label: "Contena Payments" },
          { icon: "contena-intelligence", label: "Contena Intelligence" },
