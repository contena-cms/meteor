...
import { ref } from "vue";
import MtPopover from "@contena/meteor-component-library/MtPopover";
import MtPopoverItem from "@contena/meteor-component-library/MtPopoverItem";
import MtButton from "@contena/meteor-component-library/MtButton";

const showStripes = ref(false);
const showOutlines = ref(false);
const numberedColumn = ref(false);
</script>

<template>
  <mt-popover title="Table settings">
    ...
    <template #popover-items__base>
      <mt-popover-item
        ...
        icon="solid-hashtag"
        show-switch
        :switch-value="numberedColumn"
        @change-switch="(value) => (numberedColumn = value)"
      />
