...
The Window API provides methods for navigation and window-related utilities inside the Contena Administration.

```ts
import { window as adminWindow } from "@contena/meteor-admin-sdk";
```
...
Navigate to another page inside the Contena Administration.
...
> Available since Contena v6.7.3.0
