...
> Available since Contena v6.6.9.0
...
```ts
import { iap } from "@contena/meteor-admin-sdk";
...
When called, Contena opens a purchase modal inside the Administration. The modal guides the merchant through the checkout flow for purchasing or subscribing to the feature.

After a successful purchase:

- The charge is added to the merchant's Contena bill
