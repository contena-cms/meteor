...
The meteor component library is a Vue component library developed by Contena. It is based on the [Meteor Design System](https://design.contena.cn/).

- Perfect suitable for Contena Apps
- Matches the Contena administration look and feel
- Small bundle sizes with tree-shaking
- Tested and previewed with Storybook, [documented](https://meteor.contena.cn) on meteor.contena.cn

## Requirements

You need a working **Vue 3 application** with the **i18n plugin** for the translations. Chinese and English translations are bundled in the components.
...
```cli
npm i @contena/meteor-component-library vue-i18n
```
...
```html
<script>
  import { MtButton } from "@contena/meteor-component-library";
