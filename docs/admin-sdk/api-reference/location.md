...
Locations define where extension code is executed inside the Contena Administration.
...
Check whether the current code runs inside an SDK iframe. This is mainly useful for hybrid extensions that combine plugin logic with Extension SDK logic, especially in Contena 6.6 and lower.
...
> Available since Contena v6.6.8.0
